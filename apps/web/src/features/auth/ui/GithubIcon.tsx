...
/**
 * Инлайн-SVG GitHub-марки (не lucide-react — в проекте нет иконочной библиотеки, а тащить её
 * ради одной иконки не согласовано, см. CLAUDE.md «новые библиотеки без согласования — нет»).
 * `aria-hidden`: иконка декоративна, текст кнопки уже озвучивает действие.
 */
